                ...
                <li className='flex-1'>
                    ...
                    >
                        ...
                        <div className="hidden md:inline">
                            ...
                            <p className='text-sm font-extra-light'>New Chatbot</p>
                        </div>
                    </Link>
                </li>
                <li className='flex-1'>
                    <Link href="/view-chatbot"
                        className='hover:opacity-50 flex flex-col text-center
                    lg:text-left lg:flex-row items-center gap-2 p-5 rounded-md
                    bg-[#2991EE]'>
                        ...
                        <div className="hidden md:inline">
                            ...
                            <p className='text-sm font-extra-light'>Chatbot</p>
                        </div>
                    </Link>
                </li>
                <li className='flex-1'>
                    ...
                    bg-[#2991EE]'>
                        ...
                        <div className="hidden md:inline">
                            ...
                            <p className='text-sm font-extra-light'>Sessions</p>
                        </div></Link>
                </li>
            </ul>
        </div>
